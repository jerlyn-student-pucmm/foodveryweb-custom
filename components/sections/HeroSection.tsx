      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <div className="space-y-2">
            <h1 className="text-7xl md:text-8xl font-bold text-primary tracking-tight">Food Very</h1>
            <p className="text-5xl md:text-6xl font-light text-foreground text-balance">Coffee</p>
          </div>

          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Desayuno y café elaborados con cuidado en Las Terrenas, República Dominicana
          </p>

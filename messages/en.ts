export default {
  ...
  "about": {
    ...
    "description": "At FoodVery Café, we are dedicated to providing a unique gastronomic experience that combines Dominican tradition with fresh ingredients and modern techniques. Located in the heart of Las Terrenas, we are the perfect place to start your day with the best breakfast and coffee.",
    "values": {
      "fresh": {
  ...
  "downloadApp": {
    ...
    "subtitle": "Get the FoodVery Café app for easy ordering, exclusive deals, and seamless pickup. Available on iOS and Android.",
    "features": {
      "easyOrdering": {
        "title": "Easy Ordering",
  ...
  "footer": {
    "description": "FoodVery Café - Breakfast and coffee crafted with care in Las Terrenas, Dominican Republic",
    "links": {
      "menu": "Menu",
      "about": "About",
      "contact": "Contact",
    ...
    "copyright": "© 2024 FoodVery Café. All rights reserved."
  },
  "privacy": {
    "title": "Privacy Policy",
    "lastUpdated": "Last updated: December 2024",
    "introduction": "At FoodVery Café, we respect your privacy and are committed to protecting your personal information.",
    "sections": {
      "information": {

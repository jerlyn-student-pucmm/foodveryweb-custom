export default {
  ...
  "about": {
    ...
    "description": "En Food Very Coffee, nos dedicamos a brindar una experiencia gastronómica única que combina la tradición dominicana con ingredientes frescos y técnicas modernas. Ubicados en el corazón de Las Terrenas, somos el lugar perfecto para comenzar tu día con el mejor desayuno y café.",
    "values": {
      "fresh": {
  ...
  "downloadApp": {
    ...
    "subtitle": "Obtén la app de Food Very Coffee para pedidos fáciles, ofertas exclusivas y recogida sin complicaciones. Disponible en iOS y Android.",
    "features": {
      "easyOrdering": {
  ...
  "footer": {
    "description": "Food Very Coffee - Desayuno y café elaborados con cuidado en Las Terrenas, República Dominicana",
    "links": {
      "menu": "Menú",
      "about": "Nosotros",
      "contact": "Contacto",
    ...
    "copyright": "© 2024 Food Very Coffee. Todos los derechos reservados."
  },
  "privacy": {
    "title": "Política de Privacidad",
    "lastUpdated": "Última actualización: Diciembre 2024",
    "introduction": "En Food Very Coffee, respetamos tu privacidad y nos comprometemos a proteger tu información personal.",
    "sections": {
      "information": {
